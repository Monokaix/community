...
We currently have no regular meetings to 初期没有固定会会议的时间，我们鼓励adopter member自愿host会议（request and volunteer to host the meeting）
These meetings could be held monthly, quarterly, or as needed, depending on the preferences of the group members.
The format and frequency of these meetings will be determined based on input from the community.
